...
public class Foil extends java.applet.Applet {
  ...
  public void loadOut() {   // output routine
     ...
     if (foil >= 4) {     // cylinder and ball
        ...
        if (foil == 5) lift = lift * 3.1415926 / 2.0 ;  // ball 
        lift = lift * fconv ;
        if (Math.abs(lift) <= 10.0) {
           con.outlft.setText(String.valueOf(filter3(lift)) + outunit) ;
        }
...
*/
  ...
  class Con extends Panel {
     ...
     Con (Foil target) { 
       ...
       add(new Label("Undergrad Version ", Label.CENTER)) ;
       add(bt3) ;
     ...
     public boolean action(Event evt, Object arg) {
       ...
       if(evt.target instanceof Button) {
          if(label.equals("Reset")) this.handleRset(arg) ;
          return true ;
       }
       if(evt.target instanceof Choice) {
          ...
          switch(inptopt) {
             ...
             case 1: {
                ...
                if (foil >= 4) layin.show(in, "fourth")  ;
                probflag = 0 ;
                flflag = 1 ;
                break ;
             }
      ...
      public void handleRset(Object obj) {
        float fl1,fl2,fl3 ;
        int i1,i2,i3 ;
