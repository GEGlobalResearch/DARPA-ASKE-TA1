...
>or services provided hereunder.
      ...
      New Test : 
                 ...
                 * adjust graphics so that display is the same as application         
...
public class Moc extends java.applet.Applet {
   ...
   static double varmin, varmax, var;
              ...
              //  flow parameters
   static double[][] turn    = new double[3][255] ;
   static double[][] mach1   = new double[3][255] ;
   static double[][] mach2   = new double[3][255] ;
   static double[][] prat    = new double[3][255] ;
   static double[][] trat    = new double[3][255] ;
   static double[][] ptrat   = new double[3][255] ;
   static double[][] rhorat  = new double[3][255] ;
   static double[][] defl    = new double[3][255] ;
   static double[][] shkang  = new double[3][255] ;
   static double[][] expang  = new double[3][255] ;
   static double[][] pspo    = new double[3][255] ;
   static double[][] tsto    = new double[3][255] ;
   static double[][] ptpto   = new double[3][255] ;
   static double[][] rsro    = new double[3][255] ;
   static double[][] pm      = new double[3][255] ;
   static double[][] mang    = new double[3][255] ;
   static double[][] ppt     = new double[3][255] ;
   static double[][] ttt     = new double[3][255] ;
   static double[][] rrt     = new double[3][255] ;
   static double[][] xflow   = new double[3][255] ;
   static double[][] yflow   = new double[3][255] ;
   static double[][] pres    = new double[3][255] ;
   static double[][] temp    = new double[3][255] ;
   static boolean[][] detach = new boolean[3][255] ;
              //  wedge geometry
   ...
   static double[] icinter = new double[160] ;
   static double[] icxbgn = new double[160] ;
   static double[] icxnd = new double[160] ;
   static double[] icybgn = new double[160] ;
   static double[] icynd = new double[160] ;
   static double[] icslope = new double[160] ;
              // external cowl geometry
   static double[] ecinter = new double[160] ;
   static double[] ecxbgn = new double[160] ;
   static double[] ecxnd = new double[160] ;
   static double[] ecybgn = new double[160] ;
   static double[] ecynd = new double[160] ;
   static double[] ecslope = new double[160] ;
   ...
   static double[] rpt = new double[200] ;
   static double[] rdel = new double[200] ;
   static double[] rps = new double[200] ;
   static double[] rtemp = new double[200] ;
   static double[] rrho = new double[200] ;
         // internal plume waves
   static int[] ifamily = new int[255] ;
   static double[] iinter = new double[255];
   static double[] ixbgn = new double[255] ;
   static double[] ixnd = new double[255] ;
   static double[] iybgn = new double[255] ;
   static double[] iynd = new double[255] ;
   static double[] islope = new double[255] ;
             // external plume waves
   static int[] efamily = new int[255] ;
   static double[] einter = new double[255] ;
   static double[] exbgn = new double[255] ;
   static double[] exnd = new double[255] ;
   static double[] eybgn = new double[255] ;
   static double[] eynd = new double[255] ;
   static double[] eslope = new double[255] ; 
...
//         determine nozzle pressure ratio at cowl exit 
       nprat = psth*mcpp0[numd+1][numd - numray/2 + 1] / ps0 ;
...
// geometry
      ...
      if(prob ==2 || prob == 8) {
         num.out.nozp.o32.setText(String.valueOf(filter3(Math.sqrt(4.0*aexit/pi)))) ;
         num.out.nozp.o40.setText(String.valueOf(filter3(Math.sqrt(aexit/pi)))) ;
      }
           ...
           Anlpan (Moc target) {                                                       
             ...
             class Inright extends Panel {
                ...
                Inright (Moc target) {
                  ...
                  l3 = new Label("  Version 1.15c", Label.LEFT) ;
     ...
     class Out extends Panel {
       ...
       class Noz extends Panel {
          ...
          Noz (Moc target) {
             ...
             l3 = new Label("X", Label.CENTER) ;
             l4 = new Label("Y", Label.CENTER) ;
             l7 = new Label("Q", Label.CENTER) ;
             l8 = new Label("R", Label.CENTER) ;
             l17 = new Label("alpha", Label.CENTER) ;
             l18 = new Label("beta", Label.CENTER) ;
             l19 = new Label(" ", Label.CENTER) ;
             l20 = new Label(" ", Label.CENTER) ;
       ...
       class Nozp extends Panel {
          ...
          Nozp (Moc target) {
             outerparent = target ;
             setLayout(new GridLayout(10,6,0,2)) ;
        ...
        class Nozg extends Panel {
          ...
          Nozg (Moc target) {
            ...
            prnt.appendText("MOC Version 1.15c ") ;
            add(prnt) ;
          }
        } //Nozg
...
// bottom labels
 ...
 //       offsGg.setColor(Color.red) ;
 //       offsGg.drawString("Nozzle Flows - Version 1.15c",300,10) ;
