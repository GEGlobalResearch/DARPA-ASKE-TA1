...
public interface LoggerProvider {
	 ...
	 * <p>
	 * The {@link #getSourceLogger()} method is used internally instead of this method to avoid creating a new logger instance for every {@link Source} instance,
	...
	/**
	 * Gets a shared, permanently cached {@link Logger} instance used by all {@link Source} instances.
	 * <p>
	 * The name of the returned {@link Logger} instance is "<code>net.htmlparser.jericho</code>".
	 * <p>
	 * The shared instance is created lazily and permanently cached by the relevant logging provider.
	 *
	 * @return a shared, permanently cached {@link Logger} instance used by all {@link Source} instances.
	 */
