...
/**
 * A base class used internally to simulate multiple inheritance of {@link Segment} and <code>java.util.AbstractList</code>.
 * <p>
 ...
 * @see Attributes
 */
public abstract class ListSegment<E> extends Segment implements List<E> {
	public ListSegment(final Source source, final int begin, final int end) {
